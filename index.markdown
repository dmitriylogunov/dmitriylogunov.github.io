...
This site is dedicated to my personal projects, education and life. For the career snapshot, please [download my CV](https://docs.google.com/document/d/1-d7ez5A321XL0EQmPcus7xGPVTAtTdeblUMEsGa6Wq4/export?format=docx), or see some commercial project highlights [here](/professional). Feel free to reach out via the contacts below.
