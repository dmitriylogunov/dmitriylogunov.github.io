...
<div class="posts-ribbon">
  <article class="post-card">
    ...
    <h2>Vibe Coding</h2>
    <p>It's 2025 and the Mahjong project was finally brought to completion with the help of AI and vibe coding. It's so amazing and easy, I just can't stop the flow. AI was the missing component, and I'm looking forward to building something new and exciting.</p>
    <p>What really changes everything for me is how it shifts the focus from technology and implementation details to the actual meaning and purpose of the work.</p>
  </article>
